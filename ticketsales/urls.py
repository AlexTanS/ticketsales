...
urlpatterns = [
    re_path(r"^ticket_buy/$", ticket_buy, name="ticket_buy"),
    ...
    path("api/list_of_services/", api_list_of_services, name="api_list_of_services"),
    path("api/service/", api_service, name="api_service"),
]
